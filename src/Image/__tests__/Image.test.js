...
it('renders correctly for a basic image', () => {
  const { container } = render(
    <Image src="https://raw.githubusercontent.com/bigbellies/bumbag/master/src/_docs/bean.jpg" alt="Bean" />
  );
...
it('renders correctly for a fixed image', () => {
  const { container } = render(
    <Image
      isFixed
      src="https://raw.githubusercontent.com/bigbellies/bumbag/master/src/_docs/bean.jpg"
      alt="Bean"
      width={500}
    />
  );
