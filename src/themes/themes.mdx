...
- [FontWeightsThemeConfig](#fontweightsthemeconfig)
...
The global theme config is injected into the global stylesheet of your app. It uses styled-component's [`createGlobalStyle`](https://www.styled-components.com/docs/api#createglobalstyle).
