...
You can add icons to your buttons with the `iconBefore` or `iconAfter` prop. Fannypack uses [Blueprint Icons](https://blueprintjs.com/docs/#icons) by default.
...
<Playground>
  <Set>
    ...
    <Button iconBefore="edit" palette="primary">
      Edit
    </Button>
    <Button iconAfter="arrow-right">
      Continue
    </Button>
  </Set>
</Playground>
