...
import { ButtonPropsTable } from './Button';
import {ActionButtons, ActionButtonsPropsTable} from './ActionButtons';
...
You can add icons to your buttons with the `iconBefore` or `iconAfter` prop. Fannypack uses the [free Font Awesome Icon Set](https://fontawesome.com/icons?d=gallery&m=free) by default.

<Playground>
  <Set>
    <Button iconBefore="clipboard">
      Copy
    </Button>
    <Button iconBefore="pen" palette="primary">
      Edit
    </Button>
    <Button iconAfter="long-arrow-alt-right">
      Continue
    </Button>
  </Set>
</Playground>
...
<PropsTable of={ActionButtonsPropsTable} />
