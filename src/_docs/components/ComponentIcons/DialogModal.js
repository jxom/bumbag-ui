...
const SvgComponent = props => (
  <svg width={80} height={50} fill="none" {...props}>
    <path fill="#444bc9" d="M0 0h80v50H0z" />
    <g clipPath="url(#prefix__clip0)">
      ...
      <path
        ...
        strokeWidth={0.5}
      />
      <path d="M50.044 36.466h-9.938v.817h9.938v-.817z" fill="#444bc9" />
      <path d="M66 15.667H14v3.548h52v-3.548zM40 23.118H14v3.549h26v-3.549z" fill="#444bc9" fillOpacity={0.12} />
    </g>
    <defs>
