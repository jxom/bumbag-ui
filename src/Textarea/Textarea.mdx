...
<Playground>
  ...
  <Textarea marginTop="2x" /><br/>
  <Textarea size="medium" marginTop="2x" /><br/>
  <Textarea size="large" marginTop="2x" />
</Playground>
...
<Playground>
  ...
  <Textarea state="success" marginTop="2x" /><br/>
  <Textarea state="warning" marginTop="2x" /><br/>
  <Textarea state="primary" marginTop="2x" />
</Playground>
