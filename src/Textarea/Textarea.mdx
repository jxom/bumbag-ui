...
<Playground>
  ...
  <Textarea marginTop="2u" /><br/>
  <Textarea size="medium" marginTop="2u" /><br/>
  <Textarea size="large" marginTop="2u" />
</Playground>
...
<Playground>
  ...
  <Textarea state="success" marginTop="2u" /><br/>
  <Textarea state="warning" marginTop="2u" /><br/>
  <Textarea state="primary" marginTop="2u" />
</Playground>
