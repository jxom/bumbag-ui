...
The `<Toast>` component is a bit different to the other fannypack components as you don't use the component directly. Instead, you use `Toast`'s container (`Toast.Container`) or the `withToast` higher-order component to render your toasts.
