...
<Playground>
  ...
  <br/>
  <FieldWrapper a11yId="fannypacks" validationText="Please check the box!" state="primary" marginTop="small">
    <Checkbox label="Fannypacks are great" />
  </FieldWrapper>
  <br/>
  <FieldWrapper a11yId="accept" label="Do you accept?" validationText="Nice one!" state="success" marginTop="small">
