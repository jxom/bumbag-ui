...
<Playground>
  ...
  <br/>
  <FieldWrapper a11yId="fannypacks" validationText="Please check the box!" state="primary" marginTop="5x">
    <Checkbox label="Fannypacks are great" />
  </FieldWrapper>
  <br/>
  <FieldWrapper a11yId="accept" label="Do you accept?" validationText="Nice one!" state="success" marginTop="5x">
