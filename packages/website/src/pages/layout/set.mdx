...
<Theme
  component={Set}
  overrides={['Set.css.root', 'Set.css.child.root', 'Set.css.child.first', 'Set.css.child.middle', 'Set.css.child.last', 'Set.css.horizontal', 'Set.css.child.horizontal', { key: 'Set.css.vertical', props: { orientation: 'vertical' } }, { key: 'Set.css.child.vertical', props: { orientation: 'vertical' } }]}>
  <Button>Hello</Button>
  <Button>My</Button>
  <Button>World</Button>
</Theme>
