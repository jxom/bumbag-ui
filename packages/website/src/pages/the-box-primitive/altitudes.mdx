...
Every component in Fannypack has the ability to set an `altitude` prop, allowing the component to have a sense of elevation. The `altitude` prop will give the component a box shadow.
