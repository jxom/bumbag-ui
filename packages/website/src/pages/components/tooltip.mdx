...
**<Code marginRight="major-1">unstable_hiddenId</Code>** <Code fontSize="150" palette="primary">string</Code> 
...
<Theme component={Tooltip} hasArrow content="test" overrides={['Tooltip.Reference.base', 'Tooltip.Content.base', 'Tooltip.Arrow.base']}>
  Hover me
</Theme>
