...
<Theme
  ...
  overrides={['ActionButtons.css.root', 'ActionButtons.css.child.root', 'ActionButtons.css.child.first', 'ActionButtons.css.child.middle', 'ActionButtons.css.child.last']}/>
