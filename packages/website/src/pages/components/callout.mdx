...
<Theme component={Callout} type="info" footer={<Button>Okay</Button>} showCloseButton title="Example callout" overrides={['Callout.base', 'Callout.Header.base', 'Callout.Title.base', 'Callout.Content.base', 'Callout.Footer.base', 'Callout.Close.base', 'Callout.IconWrapper.base']}>
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse diam ipsum,
  cursus id placerat congue, ultrices eget lectus. Duis posuere,
  lacus sed tristique commodo, sapien turpis mollis nunc, vestibulum
  consectetur lectus augue sit amet justo.
