...
<Theme component={Divider} highlightAttribute="border-color" overrides={['Divider.base']} />

<Theme component={Divider} highlightAttribute="border-color" overrides={['Divider.vertical.base']} orientation="vertical" />
