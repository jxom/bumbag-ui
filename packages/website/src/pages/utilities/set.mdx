...
<Theme
  component={Set}
  overrides={['Set.base', 'Set.child.base', 'Set.horizontal', 'Set.child.horizontal', { key: 'Set.vertical', props: { isVertical: true } }, { key: 'Set.child.vertical', props: { isVertical: true } }]}>
  <Button>Hello</Button>
  <Button>World</Button>
</Theme>
