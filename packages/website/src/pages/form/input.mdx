...
import { Input, InputField } from 'fannypack/Input';
...
<Theme
  ...
  overrides={[
    'Input.base',
    {key: 'Input.Wrapper.base', props: { padding: 'major-2' }},
    {key: 'Input.Spinner.base', props: { isLoading: true }},
    {key: 'Input.placeholder.base', props: { placeholder: 'I am a placeholder' }}
  ]} />
