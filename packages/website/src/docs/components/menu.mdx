...
function Example() {
  ...
  return (
    <Menu>
      <Menu.CheckboxGroup title="Sort by">
        <Menu.CheckboxItem checked={checked} onChange={setChecked}>
          Ascending
        </Menu.CheckboxItem>
      </Menu.CheckboxGroup>
    </Menu>
...
<Menu>
  <Menu.CheckboxGroup title="Sort by">
    <Menu.CheckboxItem value="asc">
      Ascending
    </Menu.CheckboxItem>
    <Menu.CheckboxItem value="desc">
      Descending
    </Menu.CheckboxItem>
  </Menu.CheckboxGroup>
</Menu>
...
- A `Menu` must consist of a set of `Menu.Item` or `Menu.Group` components.
