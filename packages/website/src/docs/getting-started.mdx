...
> Note: Make sure to install same versions on bumbag and bumbag-server packages to avoid props warnings. (as using npm / yarn install on latest version might get you different ones)
## Usage with Gatsby
