...
import { Set as BBSet } from 'bumbag-native';
...
<Theme
  component={BBSet}
  overrides={['Set.styles.base', 'Set.styles.horizontal', { key: 'Set.styles.vertical', props: { orientation: 'vertical' } }]}>
  <Button>Hello</Button>
  <Button>My</Button>
  <Button>World</Button>
</Theme>
