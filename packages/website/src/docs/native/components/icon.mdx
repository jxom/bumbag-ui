...
```jsx-live
<Icon aria-label="Igloo" icon="solid-igloo" size="100" />
<Icon aria-label="Igloo" icon="solid-igloo" />
<Icon aria-label="Igloo" icon="solid-igloo" size="300" />
<Icon aria-label="Igloo" icon="solid-igloo" size="400" />
<Icon aria-label="Igloo" icon="solid-igloo" size="500" />
<Icon aria-label="Igloo" icon="solid-igloo" size="600" />
<Icon aria-label="Igloo" icon="solid-igloo" size="700" />
<Icon aria-label="Igloo" icon="solid-igloo" size="800" />
<Icon aria-label="Igloo" icon="solid-igloo" size="900" />
```
...
<Icon aria-label="Error" icon="danger" color="danger" />
<Icon aria-label="Warning" icon="warning" color="warning" />
<Icon aria-label="Copy" icon="solid-clipboard" color="primary" />
```
...
<Flex alignY="center">
  ...
  <Icon marginLeft="minor-1" aria-label="Thumbs up" icon="solid-thumbs-up" />
</Flex>
```
