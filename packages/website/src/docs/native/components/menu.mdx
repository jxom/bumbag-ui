...
<details><Box use="summary" marginBottom="major-2">Inherits <strong><code>Pressable</code></strong> props</Box>
...
<details><Box use="summary" marginBottom="major-2">Inherits <strong><a href="https://reactnative.dev/docs/pressable">React Native's <code>Pressable</code></a></strong> props</Box>
...
**<Code fontSize="150" marginRight="major-1">hitSlop</Code>** <Code fontSize="100" palette="primary">number | Insets</Code> 

Additional distance outside of this view in which a press is detected.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">pressRetentionOffset</Code>** <Code fontSize="100" palette="primary">number | Insets</Code> 
...
**<Code fontSize="150" marginRight="major-1">android_disableSound</Code>** <Code fontSize="100" palette="primary">boolean</Code> 

If true, doesn't play system sound on touch.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">android_ripple</Code>** <Code fontSize="100" palette="primary">PressableAndroidRippleConfig</Code> 

Enables the Android ripple effect and configures its color.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">testOnly_pressed</Code>** <Code fontSize="100" palette="primary">boolean</Code> 
