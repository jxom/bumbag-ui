...
**<Code fontSize="150" marginRight="major-1">labelTextColor</Code>** <Code fontSize="100" palette="primary">any</Code> 
...
**<Code fontSize="150" marginRight="major-1">placeholderTextColor</Code>** <Code fontSize="100" palette="primary">any</Code> 

Placeholder color of the input. Can be any color in your palette.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">state</Code>** <Code fontSize="100" palette="primary">any</Code> 
