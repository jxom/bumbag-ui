...
**<Code fontSize="150" marginRight="major-1">activeThumbColor</Code>** <Code fontSize="100" palette="primary">string</Code> 

Color of the active thumb (web only).

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">activeTrackColor</Code>** <Code fontSize="100" palette="primary">string</Code> 

Color of the active track (web only).

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">align</Code>** <Code fontSize="100" palette="primary">&#34;right&#34; | &#34;left&#34;</Code> 
...
**<Code fontSize="150" marginRight="major-1">labelProps</Code>**  
...
{`{
  ...
  [x: number]: any;
  hitSlop?: Insets;
  onLayout?: ((event: LayoutChangeEvent) => void) & ((event: LayoutChangeEvent) => void);
  pointerEvents?: "auto" | ... 2 more ... | "box-only";
  ... 78 more ...;
  dataDetectorType?: "none" | ... 3 more ... | "phoneNumber";
}`}
</Code>
...
<Code isBlock palette="primary" fontSize="150" padding="minor-1" marginBottom="major-2">
{`({ checked, value }: { checked: boolean; value?: any; }) => void`}
</Code>
...
<details><Box use="summary" marginBottom="major-2">Inherits <strong><a href="https://reactnative.dev/docs/switch">React Native's <code>Switch</code></a></strong> props</Box>

**<Code fontSize="150" marginRight="major-1">thumbColor</Code>** <Code fontSize="100" palette="primary">string | typeof OpaqueColorValue</Code> 

Color of the foreground switch grip.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">trackColor</Code>** <Code fontSize="100" palette="primary">{ false: ColorValue; true: ColorValue; }</Code> 
...
**<Code fontSize="150" marginRight="major-1">onValueChange</Code>** <Code fontSize="100" palette="primary">(value: boolean) =&#62; void</Code> 
...
**<Code fontSize="150" marginRight="major-1">ios_backgroundColor</Code>** <Code fontSize="100" palette="primary">string | typeof OpaqueColorValue</Code> 
...
**<Code fontSize="150" marginRight="major-1">onTintColor</Code>** <Code fontSize="100" palette="primary">string | typeof OpaqueColorValue</Code> 

Background color when the switch is turned on.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">thumbTintColor</Code>** <Code fontSize="100" palette="primary">string | typeof OpaqueColorValue</Code> 

Color of the foreground switch grip.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">tintColor</Code>** <Code fontSize="100" palette="primary">string | typeof OpaqueColorValue</Code> 
