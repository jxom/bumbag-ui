...
<Picker
  alignCheck="right"
  options={[
    { label: 'Sunny', value: 'sunny', iconBefore: 'solid-cogs' },
    { label: 'Windy', value: 'windy', iconBefore: 'solid-users' },
    { label: 'Overcast', value: 'overcast', iconBefore: 'solid-exclamation-triangle' }
  ]}
/>
```
...
**<Code fontSize="150" marginRight="major-1">onChange</Code>** <Code fontSize="100" palette="primary">(value: string) =&#62; void</Code> 

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">options</Code>** <Code fontSize="100" palette="primary">any[]</Code> <Text marginLeft="major-1" fontSize="150" textTransform="uppercase" color="gray">Required</Text>
...
**<Code fontSize="150" marginRight="major-1">menuProps</Code>** <Code fontSize="100" palette="primary">any</Code> 

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">menuOptionGroupProps</Code>** <Code fontSize="100" palette="primary">any</Code> 
