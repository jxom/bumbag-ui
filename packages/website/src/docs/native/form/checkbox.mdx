...
import { Checkbox as BNCheckbox } from 'bumbag-native';
...
```jsx
import { Checkbox, CheckboxField } from 'bumbag-native'
```
...
It accepts a combination of [Checkbox props](/native/form/checkbox/#props) and [FieldWrapper props](/native/form/field-wrapper/#props).

```live
###tab=Default,type=jsx-live
<CheckboxField label="Check below to subscribe" checkboxLabel="Subscribe" />###

###tab=Ghost,type=jsx-live
<CheckboxField label="Check below to subscribe" checkboxLabel="Subscribe" variant="ghost" />###
```
...
###tab=Ghost,type=jsx-live
<Checkbox defaultChecked label="Remember me" variant="ghost" />###
```
...
###tab=Ghost,type=jsx-live
<Stack spacing="major-1">
  <Checkbox disabled defaultChecked label="Remember me" variant="ghost" />
  <Checkbox disabled label="Remember me" variant="ghost" />
</Stack>###
```
...
**<Code fontSize="150" marginRight="major-1">checkedColor</Code>** <Code fontSize="100" palette="primary">string</Code>

Sets the color of the checked checkbox.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">checkedIconColor</Code>** <Code fontSize="100" palette="primary">string</Code>

Sets the color of the checked icon.
...
**<Code fontSize="150" marginRight="major-1">onChange</Code>** <Code fontSize="100" palette="primary">(checked: boolean) =&#62; void</Code> <Text marginLeft="major-1" fontSize="150" textTransform="uppercase" color="gray">Required</Text>
...
<Theme
  component={BNCheckbox}
  label="Remember me"
  overrides={[
    'Checkbox.styles.base',
    'Checkbox.Icon.styles.base',
    'Checkbox.CheckIcon.styles.base',
