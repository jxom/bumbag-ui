...
The `<Text>` component renders [React Native's `<Text>`](https://reactnative.dev/docs/text) at it's core.
...
```jsx-live
<Text>
  Hello world, I am <Text fontWeight="semibold">a bit of text</Text>.
</Text>
```
