...
import { Box as BNBox, Menu as BNMenu, Key } from 'bumbag-native';
...
If you want to disable the left padding on the content, you can use the `disableLeftPadding` prop.
...
If you want to use icons on your menu items, you can use the `iconBefore` or `iconAfter` prop.

The `iconBefore` prop has the same shape as the `icon` prop of `<Icon>`.
...
If you would like the icon to appear on the right side of the menu item, you can use the `iconAfter` prop.
...
You can specify custom addon components for your menu items using the `before` or `after` prop.

```jsx-live
<Box backgroundColor="white700" padding="major-2">
  <Menu hasDividers>
    <Menu.Item
      before={<Box backgroundColor="blue" width="major-2" height="major-2" borderRadius="16px" />}
    >
      Settings
    </Menu.Item>
    <Menu.Item
      before={<Box backgroundColor="red" width="major-2" height="major-2" borderRadius="16px" />}
    >
      Accounts
    </Menu.Item>
    <Menu.Item
      before={<Box backgroundColor="orange" width="major-2" height="major-2" borderRadius="16px" />}
    >
      Alerts
    </Menu.Item>
    <Menu.Item
      before={<Box backgroundColor="purple" width="major-2" height="major-2" borderRadius="16px" />}
    >
      Security
    </Menu.Item>
  </Menu>
...
<Box backgroundColor="white700" padding="major-2">
  <Menu hasDividers>
    <Menu.Item
      after={<Box backgroundColor="blue" width="major-2" height="major-2" borderRadius="16px" />}
    >
      Settings
    </Menu.Item>
    <Menu.Item
      after={<Box backgroundColor="red" width="major-2" height="major-2" borderRadius="16px" />}
    >
      Accounts
    </Menu.Item>
    <Menu.Item
      after={<Box backgroundColor="orange" width="major-2" height="major-2" borderRadius="16px" />}
    >
      Alerts
    </Menu.Item>
    <Menu.Item
      after={<Box backgroundColor="purple" width="major-2" height="major-2" borderRadius="16px" />}
    >
      Security
    </Menu.Item>
  </Menu>
...
If you would like a menu item to be static (not clickable), you can use the `isStatic` prop.
...
**<Code fontSize="150" marginRight="major-1">disableLeftPadding</Code>** <Code fontSize="100" palette="primary">boolean</Code> 
...
**<Code fontSize="150" marginRight="major-1">hasDivider</Code>** <Code fontSize="100" palette="primary">boolean</Code> 
...
**<Code fontSize="150" marginRight="major-1">afterWrapperProps</Code>**  
...
**<Code fontSize="150" marginRight="major-1">beforeWrapperProps</Code>**  
...
**<Code fontSize="150" marginRight="major-1">contentProps</Code>**  
...
**<Code fontSize="150" marginRight="major-1">contentTextProps</Code>**  
...
<details><Box use="summary" marginBottom="major-2">Inherits <strong><code>BoxTouchable</code></strong> props</Box>

**<Code fontSize="150" marginRight="major-1">throttle</Code>** <Code fontSize="100" palette="primary">number | boolean</Code> 
...
<details><Box use="summary" marginBottom="major-2">Inherits <strong><a href="https://reactnative.dev/docs/touchableopacity">React Native's <code>TouchableOpacity</code></a></strong> props</Box>

**<Code fontSize="150" marginRight="major-1">activeOpacity</Code>** <Code fontSize="100" palette="primary">number</Code> 
...
**<Code fontSize="150" marginRight="major-1">delayLongPress</Code>** <Code fontSize="100" palette="primary">number</Code> 

Delay in ms, from onPressIn, before onLongPress is called.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">delayPressIn</Code>** <Code fontSize="100" palette="primary">number</Code> 

Delay in ms, from the start of the touch, before onPressIn is called.

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">delayPressOut</Code>** <Code fontSize="100" palette="primary">number</Code> 
...
**<Code fontSize="150" marginRight="major-1">onBlur</Code>** <Code fontSize="100" palette="primary">(e: NativeSyntheticEvent&#60;TargetedEvent&#62;) =&#62; void</Code> 
...
**<Code fontSize="150" marginRight="major-1">onFocus</Code>** <Code fontSize="100" palette="primary">(e: NativeSyntheticEvent&#60;TargetedEvent&#62;) =&#62; void</Code> 
...
**<Code fontSize="150" marginRight="major-1">onPressIn</Code>** <Code fontSize="100" palette="primary">(event: GestureResponderEvent) =&#62; void</Code> 

<Divider marginTop="major-2" marginBottom="major-2" />

**<Code fontSize="150" marginRight="major-1">onPressOut</Code>** <Code fontSize="100" palette="primary">(event: GestureResponderEvent) =&#62; void</Code> 
...
**<Code fontSize="150" marginRight="major-1">pressRetentionOffset</Code>** <Code fontSize="100" palette="primary">Insets</Code> 
...
**<Code fontSize="150" marginRight="major-1">touchSoundDisabled</Code>** <Code fontSize="100" palette="primary">boolean</Code> 
...
**<Code fontSize="150" marginRight="major-1">alignCheck</Code>** <Code fontSize="100" palette="primary">&#34;right&#34; | &#34;left&#34;</Code> <Text marginLeft="major-1" fontSize="150" textTransform="uppercase" color="gray">Required</Text>
...
**<Code fontSize="150" marginRight="major-1">alignCheck</Code>** <Code fontSize="100" palette="primary">&#34;right&#34; | &#34;left&#34;</Code> 
...
**<Code fontSize="150" marginRight="major-1">checkIcon</Code>**  
...
<Code isBlock palette="primary" fontSize="150" padding="minor-1" marginBottom="major-2">
{`({ checked: boolean, value: string }: { checked: any; value: any; }) => void`}
</Code>
...
<details><Box use="summary" marginBottom="major-2">Inherits <strong><code>MenuItem</code></strong> props</Box>
...
<Theme component={BNBox} overrides={['Menu.styles.base', 'Menu.Item.styles.base', 'Menu.Item.Content.styles.base', 'Menu.Item.ContentText.styles.base']}>
  {props => (
    <BNMenu overrides={props.overrides}>
      <BNMenu.Item>
        General
      </BNMenu.Item>
      <BNMenu.Item>
