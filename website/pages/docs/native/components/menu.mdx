...
<Theme component={'Box'} platform="native" overrides={['Menu.styles.base', 'Menu.Item.styles.base', 'Menu.Item.Content.styles.base', 'Menu.Item.ContentText.styles.base']}>
  {props => (
