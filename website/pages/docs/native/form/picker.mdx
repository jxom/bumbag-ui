...
> This component requires you to install `@bumbag-native/picker` as a separate dependency.
...
{`({ key?: string; label: string; value: any; disabled?: boolean; } & Partial<MenuOptionItemProps>)[]`}
</Code>
...
**<Code fontSize="150" marginRight="major-1">listProps</Code>**  
...
{`{
  ...
  children?: string | number | boolean | {
     | ReactElement<any, string | ((props: any) => ReactElement<any, string | ... | (new (props: any) => Component<...>)>) | (new (props: any) => Component<...>)> | ReactNodeArray | Reac...`}
</Code>
