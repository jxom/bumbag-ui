...
import { SwitchGroup as BNSwitchGroup, SwitchGroupField as BNSwitchGroupField } from 'bumbag-native';
...
```jsx
import { SwitchGroup, SwitchGroupField } from 'bumbag-native'
```
...
**<Code fontSize="150" marginRight="major-1">options</Code>** <Code fontSize="100" palette="primary">never[]</Code> <Text marginLeft="major-1" fontSize="150" textTransform="uppercase" color="gray">Required</Text>
...
### SwitchGroupField Props

<!-- Automatically generated -->

**<Code fontSize="150" marginRight="major-1">switchGroupProps</Code>**  
...
<details><Box use="summary" marginBottom="major-2">Inherits <strong><code>SwitchGroup</code></strong> props</Box>
...
### SwitchGroup
 ...
 <Theme
  ...
  overrides={[
    ...
    'SwitchGroup.Item.styles.base'
  ]} />

### SwitchGroupField

 <Theme
  component={'BNSwitchGroupField'}
  label="Weather"
  options={[
    { label: 'Sunny', value: 'sunny' },
    { label: 'Windy', value: 'windy' },
