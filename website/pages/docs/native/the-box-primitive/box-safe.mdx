...
Wrapper around [React Native's `SafeAreaView`](https://reactnative.dev/docs/next/safeareaview).
...
<Theme component={'BoxSafe'} platform="native" overrides={['Box.Safe.styles.base']}>This is a box</Theme>
