...
Wrapper around [React Native's `TouchableOpacity`](https://reactnative.dev/docs/next/touchableopacity).
...
```jsx-live
<Box.Touchable onPress={() => alert('Hello!')}>
  <Text>Touch me</Text>
</Box.Touchable>
```
...
<Theme component={'BoxTouchable'} platform="native" overrides={['Box.Touchable.styles.base']}>
