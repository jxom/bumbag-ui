...
The `<Box>` renders [React Native's `<View>`](https://reactnative.dev/docs/view) component at it's core.
...
<Theme component={'Box'} platform="native" overrides={['Box.styles.base']}>This is a box</Theme>
