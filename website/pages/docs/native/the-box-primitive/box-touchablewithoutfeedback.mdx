---
title: Box.TouchableWithoutFeedback
group: Primitives
---

# Box.TouchableWithoutFeedback

Wrapper around [React Native's `TouchableWithoutFeedback`](https://reactnative.dev/docs/next/TouchableWithoutFeedback).
...
```jsx-live
<Box.TouchableWithoutFeedback onPress={() => alert('Hello!')}>
  <Text>Hello world</Text>
</Box.TouchableWithoutFeedback>
```

## Box.TouchableWithoutFeedback Props
...
<details><Box use="summary" marginBottom="major-2">Inherits <strong><a href="https://reactnative.dev/docs/touchablewithoutfeedback">React Native's <code>TouchableWithoutFeedback</code></a></strong> props</Box>
...
<Theme component={'BoxTouchableWithoutFeedback'} platform="native" overrides={['Box.TouchableWithoutFeedback.styles.base']}>
