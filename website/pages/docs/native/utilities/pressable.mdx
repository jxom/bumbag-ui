...
import { Box, Pressable, Text } from 'bumbag-native';

# Pressable

Wrapper around [React Native's `Pressable`](https://reactnative.dev/docs/next/pressable).

## Import

```js
import { Pressable } from 'bumbag-native';
```
...
<Theme component={Pressable} overrides={['Pressable.styles.base']}>
