...
- **[style props](/native/the-box-primitive/style-props) (recommended)**: Allowing you to add CSS as props on your components.
...
// import { Button, applyTheme, css } from 'bumbag-native';
...
```jsx
import { styled, css } from 'bumbag-native';
...
```function-live noInline
// import { Box, styled } from 'bumbag-native';

const FancyBox = styled(Box)(props => ({
  backgroundColor: props.palette
}));
...
```function-live noInline
// import { Box, styled, palette } from 'bumbag-native';

const FancyBox = styled(Box)(props => ({
  backgroundColor: palette('primary')(props),
  color: palette('primaryTint')(props)
}));
...
const FancyBox = styled(Box)(props => ({
  backgroundColor: palette('primary')(props),
  padding: `${space(2, 'major')(props)}px`,
  color: palette('primaryTint')(props),
}));
...
```function-live noInline
// import { Box, styled, font, fontSize, fontWeight } from 'bumbag-native';

const FancyBox = styled(Box)(props => ({
  fontFamily: font('Comic Sans MS')(props),
  fontSize: fontSize('400')(props),
  fontWeight: fontWeight('semibold')(props)
}));
...
```function-live noInline
// import { Box, styled, border, palette } from 'bumbag-native';

const FancyBox = styled(Box)(props => ({
  border: border('default')(props)
}));
...
```function-live noInline
// import { Box, styled, borderRadius, palette } from 'bumbag-native';

const FancyBox = styled(Box)(props => ({
  border: '1px solid black',
  borderRadius: borderRadius('4')(props)
}));
