...
Index.getLayout = (page) => <LandingLayout>{page}</LandingLayout>;
    ...
    <>
          ...
          <Stack textAlign="center" spacing="major-3">
            ...
            <Set verticalBelow="mobile" isFilled spacing="major-2" width={{ mobile: '100%' }}>
              <NextLink href="/docs/getting-started/" passHref>
                <Button use="a" variant="cta" palette="primary" width="140px">
                  Web
                </Button>
              </NextLink>
              <NextLink href="/docs/getting-started/" passHref>
      ...
      >
        <Stack>
          ...
          <NextLink href="/the-box-primitive/style-props/" passHref>
            <Link.Block fontWeight="500" fontSize="400">
              Learn more
    ...
    >
      ...
      >
        <Stack>
          ...
          <NextLink href="/color-modes/" passHref>
            <Link.Block fontWeight="500" fontSize="400">
              Learn more
              <Icon marginLeft="major-1" verticalAlign="0" icon="solid-arrow-right" fontSize="200" />
            </Link.Block>
    ...
    We were unable to save your changes.
      ...
      >
        <Stack>
          ...
          <NextLink href="/theming/" passHref>
            <Link.Block fontWeight="500" fontSize="400">
              Learn more
              <Icon marginLeft="major-1" verticalAlign="0" icon="solid-arrow-right" fontSize="200" />
            </Link.Block>
        ...
        <Columns spacing="major-6">
          <Columns.Column spread={8}>
            <Stack spacing="major-6">
              ...
              <Text.Block fontSize="400" color="text200" lineHeight="default" maxWidth="768px">
                Join our discord server to get the latest updates, chat with other Bumbag enthusiasts, and see what{"'"}
